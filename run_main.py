...
logging.basicConfig(filename=os.path.join(datapath, "sample.log"), level=logging.INFO, filemode = "w")
...
main.process_all_dfs(seg_length = 100, overlap = 0.7, folder_name = "test_removing_duplicates",
                data_folder_path = datapath, 
                data_nt = df_nt, data_procaine = df_procaine, data_saline = df_saline, 
                arena = temp_arena)

main.process_all_dfs(seg_length = 150, overlap = 0.7, folder_name = "test_removing_duplicates",
                data_folder_path = datapath, 
                data_nt = df_nt, data_procaine = df_procaine, data_saline = df_saline, 
                arena = temp_arena)
                
main.process_all_dfs(seg_length = 200, overlap = 0.7, folder_name = "test_removing_duplicates",
                data_folder_path = datapath, 
                data_nt = df_nt, data_procaine = df_procaine, data_saline = df_saline, 
                arena = temp_arena)
                
main.process_all_dfs(seg_length = 250, overlap = 0.7, folder_name = "test_removing_duplicates",
                data_folder_path = datapath, 
                data_nt = df_nt, data_procaine = df_procaine, data_saline = df_saline, 
                arena = temp_arena)